...
with open("SFMShop/data/errors.log", "a") as file:
    file.write(error_message)

# Практика: Задание 1 - Чтение и запись товаров
# Чтение товаров из файла
with open("SFMShop/data/products.txt", "r") as file:
    lines = file.readlines()

# Обработка товаров и запись в новый файл
with open("SFMShop/data/products_with_prices.txt", "w") as file:
    for line in lines:
...
from models.payment import Payment, CardPayment, PayPalPayment
